...
export default function Footer() {
    return (
        <footer class="p-4 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 - {presentDate} <a href="https://kittipot.vercel.app/" class="hover:underline">Kittipot Laorngsri</a> All Rights Reserved.
            </span>
